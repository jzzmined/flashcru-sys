                ...
                <?php else: ?>
                    <div class="fc-card-header">
                        <div class="fc-card-title">
                            <i class="bi bi-clock-history" style="color:var(--fc-primary)"></i> My Reports
                        </div>
                    </div>
                                ...
                                <div class="fc-log-scroll">
                                    <?php while ($r = $reports->fetch_assoc()): ?>
                                        <tr id="report-<?= $r['id'] ?>">
                                            ...
                                            <td>
                                                <span
                                                    style="background:<?= $r['status_color'] ?>22;color:<?= $r['status_color'] ?>;padding:3px 10px;border-radius:100px;font-size:11px;font-weight:600;">
                                            ...
                                            <td>
                                                <?php if ((int) $r['status_id'] === 1): ?>
                                                    ...
                                                    <button class="fc-icon-btn" title="Edit Report" data-bs-toggle="modal"
                                                        data-bs-target="#editModal<?= $r['id'] ?>">
                                                        <i class="bi bi-pencil-fill"></i>
                                                    </button>
                                                    <!-- Cancel button — only for Pending -->
                                                    <button class="fc-icon-btn" title="Cancel Report"
                                                        style="color:var(--fc-danger);" data-bs-toggle="modal"
                                        ...
                                        <?php if (!empty($r['description'])): ?>
                                            <tr style="background:#fafbff;">
                                                <td colspan="8"
                                                    style="padding:8px 18px 13px;color:var(--fc-muted);font-size:12.5px;border-top:none;">
                                                    <i class="bi bi-chat-text-fill"
                                                        style="color:var(--fc-primary);margin-right:6px;"></i>
                                                    ...
                                                    <form method="POST">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="street_landmark"
                                                                    class="fc-form-control" placeholder="e.g. Near the market"
                                                    ...
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">
                                                            <i class="bi bi-exclamation-triangle-fill"
                                                                style="color:var(--fc-danger);margin-right:8px;"></i>
                                                            Cancel Report
                                                        </h5>
                                                        <button class="btn-close" data-bs-dismiss="modal"></button>
                                                    </div>
                                                    <div class="modal-body" style="font-size:13.5px;">
                                                        Are you sure you want to cancel <strong>Report
                                                            #<?= $r['id'] ?></strong>?
